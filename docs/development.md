...
Tests are split by responsibility: small inference/shape/canonical unit tests in core; workspace atomicity, revisions and continuations as core integration tests; semantic execution in eval; line-level envelopes and the full example in protocol.
