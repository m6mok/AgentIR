...
The first process writes an archive v5 at `/tmp/agentir-example.agentir.json`; the second verifies its checksum, SpecIR and mixed candidate event semantics, proposal/proof state, semantic hash caches and complete replay before serving `r1`:
