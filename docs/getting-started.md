...
The first process writes an archive v4 at `/tmp/agentir-example.agentir.json`; the second verifies its checksum, SpecIR and candidate event semantics versions, semantic hash caches and complete replay before serving `r1`:
