...
Evaluation archive v8 is separate from workspace archive v10. New evaluation saves use v8 and retain campaign plans, sessions, checkpoints, traces, results, stopping reasons through sessions/results, work counters, exact embedded Stage 7A–7D references, and zero-device replay statuses.
