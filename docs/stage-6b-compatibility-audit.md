...
Stage 6B adds only `agentir.evaluation.choice_set.v1`, `feature_schema.v1`, `ranking_policy.v1`, `ranking_trace.v1`, `selection.v1`, ranked episode v2, and evaluation archive v2 domains. Ranking limits enter none of the compiler or workspace identities.
