...
Stage 8C adds no proof relation. Its offline closure gate jointly exercises the existing Stage 8A certificate, deterministic interpreter, isolated synthetic measurement orchestration, artifact/hash stability, and archive replay. The real monotonic smoke observation has no threshold; neither synthetic nor physical timing advances the compiler frontier or grants performance authority.
